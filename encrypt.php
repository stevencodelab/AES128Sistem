<?php
$title = 'Halaman Enkripsi Dokumen';
session_start();
...
<div class="col-md-12">
  ...
  <fieldset>
                        ...
                        <div class="form-group">
                          <label class="col-lg-6 control-label" for="inputFile">Dokumen</label>
                          <div class="col-lg-8">
                            <input class="form-control" id="inputFile" placeholder="Masukkan File" type="file" name="file" required>
                          </div>
                        </div>
                        <div class="form-group">
                          <label class="col-lg-8 control-label" for="inputPassword">Password</label>
                          <div class="col-lg-8">
                            <input class="form-control" id="inputPassword" type="password" placeholder="Masukkan Password Untuk Mengenkripsi Dokumen" name="pwdfile" required>
                          </div>
                        </div>
                        <div class="form-group">
                          <label class="col-lg-2 control-label" for="textArea">Keterangan</label>
                          <div class="col-lg-8">
                            <textarea class="form-control" id="textArea" rows="4" name="desc" placeholder="Keterangan Dokumen"></textarea>
                          </div>
                        </div>
                        <div class="form-group">
                          <label class="col-lg-2 control-label" for="textArea"></label>
                          <div class="col-lg-2">
                            <input type="submit" name="encrypt_now" value="Proses Enkrip" class="form-control btn btn-primary">
                          </div>
                        </div>
                      </fieldset>
                    </form>
